...
```bash
scp -r training-server-agent ailab2@172.16.8.60:/home/ailab2/Workspace/Intellivix_MLops_train_server/
```

학습 서버에서 기대하는 workspace 구조:

```text
/home/ailab2/Workspace/Intellivix_MLops_train_server/
├── dataset/
...
```bash
cd /home/ailab2/Workspace/Intellivix_MLops_train_server/training-server-agent
cp .env.example .env
...
```json
{
  ...
  "args": [
    ...
    "--dataset", "/home/ailab2/Workspace/Intellivix_MLops_train_server/dataset/integrated",
    "--output-dir", "/home/ailab2/Workspace/Intellivix_MLops_train_server/detector/runs",
    "--data-config", "/home/ailab2/Workspace/Intellivix_MLops_train_server/detector/configs/data.yaml",
    "--model", "/home/ailab2/Workspace/Intellivix_MLops_train_server/detector/weights/yolo26l.pt",
    "--epochs", "5"
  ],
  "callbackUrl": "http://172.16.8.100:18088/api/training/jobs/train_20260807_abc123/callback",
  "parameters": {
    "datasetConfigYaml": "# Ultralytics ...\npath: ...\nnames:\n  0: person\n",
    "datasetConfigAbsolutePath": "/home/ailab2/Workspace/Intellivix_MLops_train_server/detector/configs/data.yaml"
  }
}
```
...
Type=simple
User=ailab2
WorkingDirectory=/home/ailab2/Workspace/Intellivix_MLops_train_server/training-server-agent
ExecStart=/home/ailab2/Workspace/Intellivix_MLops_train_server/training-server-agent/run-agent.sh
Restart=always
