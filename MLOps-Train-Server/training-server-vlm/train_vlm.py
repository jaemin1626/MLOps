...
def load_model_and_processor(
    ...
    from vlm_model_utils import load_vlm_model_and_processor

    try:
        model, processor, resolved_path = load_vlm_model_and_processor(
            base_model,
    ...
    print(f"base_model={resolved_path}", flush=True)
